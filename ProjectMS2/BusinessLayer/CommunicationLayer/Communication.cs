...
namespace Project2.CommunicationLayer
{
    ...
    { //sealed modifier prevents other classes from inheriting from it
        ...
        public IMessage Send(string url, string gourpID, string Username, string messageContent)
        {
            return SimpleHTTPClient.SendPostRequest(url, new Request(new Guid(), gourpID, Username, messageContent, 0, "1"));
        }
        ...
        private class Request
        {
            ...
            public Request(Guid messageGuid, string groupID, string Username, string messageContent, long msgDate, string messageType)
            {
